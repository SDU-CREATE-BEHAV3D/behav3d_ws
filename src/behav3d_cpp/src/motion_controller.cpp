...
#define MC_DEBUG(node, fmt, ...) RCLCPP_DEBUG((node)->get_logger(), "[MotionController] " fmt, ##__VA_ARGS__)
#define MC_INFO(node, fmt, ...) RCLCPP_INFO((node)->get_logger(), "[MotionController] " fmt, ##__VA_ARGS__)
#define MC_WARN(node, fmt, ...) RCLCPP_WARN((node)->get_logger(), "[MotionController] " fmt, ##__VA_ARGS__)
#define MC_ERROR(node, fmt, ...) RCLCPP_ERROR((node)->get_logger(), "[MotionController] " fmt, ##__VA_ARGS__)
